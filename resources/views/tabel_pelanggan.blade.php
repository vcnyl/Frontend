...
<body>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="judul">Data Pelanggan</div>
            </div>
            <div class="col-md-4">
                <div class="search-box">
                    <!-- Tempatkan kotak pencarian di sini -->
                    <form action="/get_search_pelanggan" method="GET">
                        <div class="input-group">
                            <input type="text" class="form-control" placeholder="Nama/No Telepon/Alamat"
            ...
            <div class="col-md-3 mt-2 text-right">
                <form action="/form_input_pelanggan">
                    @csrf
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $p->no_telp }}</td>
                            <td>
                                <form action="{{ url('/get_detail_pelanggan/'.$p->id) }}">
                                    @csrf
